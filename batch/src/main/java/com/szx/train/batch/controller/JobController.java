package com.szx.train.batch.controller;


import com.szx.train.batch.req.CronJobReq;
import com.szx.train.batch.resp.CronJobResp;
import com.szx.train.batch.utils.ClassScanner;
...
public class JobController {
    ...
    public CommonResp scanner() {
        LOG.info("扫描定时任务全类名开始");
        List<String> list = ClassScanner.ScanPackage("com.szx.train.batch.job");
        CommonResp commonResp = new CommonResp();
