...
import com.szx.train.business.service.StationService;
...
public class StationAdminController {
    ...
    @GetMapping("/query/{id}")
    public CommonResp<StationQueryResp> query(@PathVariable Long id) {
        return new CommonResp<>(stationService.queryById(id));
    }
