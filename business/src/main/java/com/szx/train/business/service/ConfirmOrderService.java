...
public class ConfirmOrderService extends ServiceImpl<ConfirmOrderMapper, ConfirmOrder> {
    ...
    public PageResp<ConfirmOrderQueryResp> queryList(ConfirmOrderQueryReq req) {
        ...
        IPage<ConfirmOrder> list = lambdaQuery()
                .eq(req.getDate() != null, ConfirmOrder::getDate, req.getDate())
                .eq(StrUtil.isNotBlank(req.getTrainCode()), ConfirmOrder::getTrainCode, req.getTrainCode())
    ...
    public void doConfirmOrder(ConfirmOrderMQDto dto) {
...
//        }
        ...
        String lockKey = dto.getDate() + "-" + dto.getTrainCode();
...
//                throw new BusinessException(BusinessExceptionEnum.CONFIRM_ORDER_LOCK_FAIL);
            ...
            while (true){
                ...
                try {
                    ...
                    if(e.getE().equals(BusinessExceptionEnum.BUSINESS_TICKET_INSUFFICIENT)){
                        LOG.info("余票不足, 继续下一个订单");
                        lambdaUpdate()
    ...
    public void sell(ConfirmOrder confirmOrder){
        ...
        Long memberId = confirmOrder.getMemberId();

        // 将订单状态改为处理中
        LOG.info("将订单状态改为处理中, 避免重试 confirm_order.id: {}", confirmOrder.getId());
        lambdaUpdate()
                .eq(ConfirmOrder::getId, confirmOrder.getId())
